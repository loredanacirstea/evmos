...
- [evmos/cronjobs/v1/genesis.proto](#evmos/cronjobs/v1/genesis.proto)
    ...
    - [Params](#evmos.cronjobs.v1.Params)
  
- [evmos/cronjobs/v1/query.proto](#evmos/cronjobs/v1/query.proto)
    - [QueryCronjobRequest](#evmos.cronjobs.v1.QueryCronjobRequest)
    - [QueryCronjobResponse](#evmos.cronjobs.v1.QueryCronjobResponse)
    - [QueryCronjobsRequest](#evmos.cronjobs.v1.QueryCronjobsRequest)
    - [QueryCronjobsResponse](#evmos.cronjobs.v1.QueryCronjobsResponse)
    - [QueryParamsRequest](#evmos.cronjobs.v1.QueryParamsRequest)
    - [QueryParamsResponse](#evmos.cronjobs.v1.QueryParamsResponse)
  
    - [Query](#evmos.cronjobs.v1.Query)
  
- [evmos/cronjobs/v1/tx.proto](#evmos/cronjobs/v1/tx.proto)
    - [MsgCancelCronjob](#evmos.cronjobs.v1.MsgCancelCronjob)
    - [MsgCancelCronjobResponse](#evmos.cronjobs.v1.MsgCancelCronjobResponse)
    - [MsgRegisterCronjob](#evmos.cronjobs.v1.MsgRegisterCronjob)
    - [MsgRegisterCronjobResponse](#evmos.cronjobs.v1.MsgRegisterCronjobResponse)
  
    - [Msg](#evmos.cronjobs.v1.Msg)
...
<a name="evmos/cronjobs/v1/cronjob.proto"></a>
<p align="right"><a href="#top">Top</a></p>

## evmos/cronjobs/v1/cronjob.proto



<a name="evmos.cronjobs.v1.Cronjob"></a>
...
<a name="evmos/cronjobs/v1/genesis.proto"></a>
<p align="right"><a href="#top">Top</a></p>

## evmos/cronjobs/v1/genesis.proto



<a name="evmos.cronjobs.v1.GenesisState"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `params` | [Params](#evmos.cronjobs.v1.Params) |  | params defines all the parameters of the module. |
| `cronjobs` | [Cronjob](#evmos.cronjobs.v1.Cronjob) | repeated | list of claim records with the corresponding airdrop recipient |
...
<a name="evmos.cronjobs.v1.Params"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `enable_cronjobs` | [bool](#bool) |  | enable cronjobs |
...
<a name="evmos/cronjobs/v1/query.proto"></a>
<p align="right"><a href="#top">Top</a></p>

## evmos/cronjobs/v1/query.proto



<a name="evmos.cronjobs.v1.QueryCronjobRequest"></a>
...
<a name="evmos.cronjobs.v1.QueryCronjobResponse"></a>

### QueryCronjobResponse
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `cronjob` | [Cronjob](#evmos.cronjobs.v1.Cronjob) |  | cronjob |
...
<a name="evmos.cronjobs.v1.QueryCronjobsRequest"></a>

### QueryCronjobsRequest
...
<a name="evmos.cronjobs.v1.QueryCronjobsResponse"></a>

### QueryCronjobsResponse
QueryCronjobsResponse is the response type for the Query/Cronjobs
RPC method.
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `cronjobs` | [Cronjob](#evmos.cronjobs.v1.Cronjob) | repeated | cronjob |
| `pagination` | [cosmos.base.query.v1beta1.PageResponse](#cosmos.base.query.v1beta1.PageResponse) |  | pagination defines the pagination in the response. |
...
<a name="evmos.cronjobs.v1.QueryParamsRequest"></a>
...
<a name="evmos.cronjobs.v1.QueryParamsResponse"></a>
...
| Field | Type | Label | Description |
| ----- | ---- | ----- | ----------- |
| `params` | [Params](#evmos.cronjobs.v1.Params) |  | params defines the parameters of the module. |
...
<a name="evmos.cronjobs.v1.Query"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `Cronjobs` | [QueryCronjobsRequest](#evmos.cronjobs.v1.QueryCronjobsRequest) | [QueryCronjobsResponse](#evmos.cronjobs.v1.QueryCronjobsResponse) | Cronjobs queries the cronjobs by epoch identifier | GET|/evmos/cronjobs/v1/{epoch_identifier}|
| `Cronjob` | [QueryCronjobRequest](#evmos.cronjobs.v1.QueryCronjobRequest) | [QueryCronjobResponse](#evmos.cronjobs.v1.QueryCronjobResponse) | Cronjob queries the cronjobs by epoch identifier | GET|/evmos/cronjobs/v1/{identifier}|
| `Params` | [QueryParamsRequest](#evmos.cronjobs.v1.QueryParamsRequest) | [QueryParamsResponse](#evmos.cronjobs.v1.QueryParamsResponse) | Params returns the claims module parameters | GET|/evmos/cronjobs/v1/params|

 <!-- end services -->



<a name="evmos/cronjobs/v1/tx.proto"></a>
<p align="right"><a href="#top">Top</a></p>

## evmos/cronjobs/v1/tx.proto



<a name="evmos.cronjobs.v1.MsgCancelCronjob"></a>
...
<a name="evmos.cronjobs.v1.MsgCancelCronjobResponse"></a>

### MsgCancelCronjobResponse
...
<a name="evmos.cronjobs.v1.MsgRegisterCronjob"></a>
...
| ----- | ---- | ----- | ----------- |
| `cronjob` | [Cronjob](#evmos.cronjobs.v1.Cronjob) |  | Cronjob |
| `sender` | [string](#string) |  | EOA/contract hex address |
...
<a name="evmos.cronjobs.v1.MsgRegisterCronjobResponse"></a>

### MsgRegisterCronjobResponse
MsgConvertCoinResponse returns no fields
...
<a name="evmos.cronjobs.v1.Msg"></a>
...
| Method Name | Request Type | Response Type | Description | HTTP Verb | Endpoint |
| ----------- | ------------ | ------------- | ------------| ------- | -------- |
| `RegisterCronjob` | [MsgRegisterCronjob](#evmos.cronjobs.v1.MsgRegisterCronjob) | [MsgRegisterCronjobResponse](#evmos.cronjobs.v1.MsgRegisterCronjobResponse) | RegisterCronjob | GET|/evmos/cronjobs/v1/tx/register_cronjob|
| `CancelCronjob` | [MsgCancelCronjob](#evmos.cronjobs.v1.MsgCancelCronjob) | [MsgCancelCronjobResponse](#evmos.cronjobs.v1.MsgCancelCronjobResponse) | CancelCronjob | GET|/evmos/cronjobs/v1/tx/cancel_cronjob|
